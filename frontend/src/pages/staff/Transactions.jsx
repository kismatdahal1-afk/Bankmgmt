      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', marginBottom: '12px', flexWrap: 'wrap' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', alignItems: 'stretch' }}>
          <div style={{ display: 'flex', gap: '8px' }}>
            <Link to="/staff/transactions/deposit" className="btn btn-success btn-sm" style={{ minWidth: '130px', textAlign: 'center' }}>
              <span className="material-symbols-rounded" style={{ fontSize: '16px', verticalAlign: 'middle' }}>add_circle</span> Deposit
            </Link>
            <Link to="/staff/transactions/withdraw" className="btn btn-danger btn-sm" style={{ minWidth: '130px', textAlign: 'center' }}>
