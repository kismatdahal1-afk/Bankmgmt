      ...
      <div className="table-container" style={{ marginBottom: '16px', padding: '16px 20px' }}>
        ...
        <div style={{ display: 'flex', gap: '6px' }}>
          ...
          <div style={{ display: 'flex', gap: '4px', flexShrink: 0, alignSelf: 'flex-end' }}>
            <Link to="/staff/transactions/deposit" className="btn btn-success btn-sm" style={{ width: '85px', textAlign: 'center', padding: '3px 4px', fontSize: '0.78rem', height: '28px' }}>
        ...
        <div style={{ display: 'flex', gap: '6px' }}>
          ...
          <div style={{ display: 'flex', gap: '4px', flexShrink: 0 }}>
            <Link to="/staff/transactions/withdraw" className="btn btn-danger btn-sm" style={{ width: '85px', textAlign: 'center', padding: '3px 4px', fontSize: '0.78rem', height: '28px' }}>
