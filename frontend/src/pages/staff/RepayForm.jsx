            ...
            <div className="form-group">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '8px' }}>
                ...
                <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', color: 'var(--text-primary)' }}>
                  ...
                  {activeAccount ? (
                    <span style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>(Acc: {activeAccount.account_number} - Bal: {formatCurrency(activeAccount.balance)})</span>
                  ) : (
                    <span style={{ fontSize: '0.8rem', color: 'var(--danger)' }}>(No active savings account)</span>
                  )}
                </label>
              </div>
            </div>
