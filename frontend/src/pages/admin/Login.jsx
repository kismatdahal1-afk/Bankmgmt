  ...
  return (
    <div className="login-shell">
      <div className="login-card">
        ...
        <div className="login-sub">Enter your credentials to manage system settings.</div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input type="text" id="username" name="username" className="form-control" placeholder="e.g. admin" required autoFocus
        ...
        <div style={{ textAlign: 'center', marginTop: '18px', fontSize: '13px', color: 'var(--text-muted)' }}>
          <Link to="/staff/login" style={{ color: 'var(--accent)' }}>Staff Portal</Link> &middot; <Link to="/" style={{ color: 'var(--accent)' }}>Home</Link>
        </div>
      </div>
    </div>
  )
